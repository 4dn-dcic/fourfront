...
Documentation on how to get started with this interface is [here](/help/submitter-guide/web-submission).
...
[here](/help/submitter-guide/spreadsheet).
...
If you would like to directly interact with the REST API for data submission see the documentation [here](/help/user-guide/rest-api).
...
For instructions on creating an account, please see [this page](/help/user-guide/account-creation).
...
1. Log in to the 4DN [website](https://data.4dnucleome.org) with your username (email) and password. If you have not yet created an account, see [this page](/help/user-guide/account-creation) for instructions.
...
4. Create a file to store this information.  
    ...
    * You can use the same key and secret to use the 4DN [REST-API](/help/user-guide/rest-api).
