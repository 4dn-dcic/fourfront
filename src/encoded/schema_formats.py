...
accession_re = re.compile(r'^4DN(EX|FI|FS|SR|BS|IN|PL)[0-9][0-9][0-9][A-Z][A-Z][A-Z]$')
test_accession_re = re.compile(r'^TST(EX|FI|FS|SR|BS|IN|PL)[0-9][0-9][0-9]([0-9][0-9][0-9]|[A-Z][A-Z][A-Z])$')
