...
TSV_MAPPING = OrderedDict([
   ...
   #('Digestion Enzyme',            (EXP,       ['digestion_enzyme.name'])),
    ...
    ('Assay Info',                  (FILE,      ['track_and_facet_info.assay_info'])),
    ('Biosource Name',              (FILE,      ['track_and_facet_info.biosource_name'])),
    ('Condition',                   (FILE,      ['track_and_facet_info.condition'])),
    ('Dataset',                     (FILE,      ['track_and_facet_info.dataset'])),
    ('Experiment Bucket',           (FILE,      ['track_and_facet_info.experiment_bucket'])),
    ('Lab Name',                    (FILE,      ['track_and_facet_info.lab_name'])),
    ('Replicate Info',              (FILE,      ['track_and_facet_info.replicate_info'])),
    ('Track Title',                 (FILE,      ['track_and_facet_info.track_title'])),
    #('UUID',                        (FILE,      ['uuid'])),
