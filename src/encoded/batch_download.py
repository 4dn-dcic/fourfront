    ...
    def should_file_row_object_be_included(column_vals_dict):
        ...
        for set_accession, exp_accession, file_accession in accession_triples:
            if (
                ...
                # if exp_accession and exp_accession != 'NONE' and len(column_vals_dict['File Classification']) > 0 and column_vals_dict['File Classification'] != 'processed file':
                ...
                # if exp_accession and exp_accession != 'NONE' and column_vals_dict['Related File Relationship'] == 'reference file for':
