...
def includeme(config):
    ...
    config.add_route('bar_plot_chart_deprecated', '/bar_plot_aggregations_deprecated')
...
@view_config(route_name='bar_plot_chart_deprecated', request_method=['GET', 'POST'])
def bar_plot_chart_deprecated(request):
