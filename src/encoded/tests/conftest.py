...
from .conftest_es import (
    es_app, es_app_settings,
    anon_es_testapp, anon_html_es_testapp, es_testapp, html_es_testapp,
    indexer_testapp, workbook,
)
...
README:
    * This file contains application level fixtures and hooks in the server/data fixtures present in
      other files.
    * See also "es_app" fixtures in conftest_es.py that are imported here for definitional reasons.
"""

notice_pytest_fixtures(es_app, es_app_settings,
                       anon_es_testapp, anon_html_es_testapp,
                       es_testapp, html_es_testapp,
                       indexer_testapp, workbook)
