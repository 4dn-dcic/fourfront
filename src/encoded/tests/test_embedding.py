...
def test_embedded_linked_uuids_object(content, dummy_request, threadlocals):
    ...
    assert dummy_request._embedded_uuids == set('16157204-8c8f-4672-a1a4-14f4b8021fcd')
    assert dummy_request._linked_uuids == set('16157204-8c8f-4672-a1a4-14f4b8021fcd')
...
def test_embedded_uuids_embedded(content, dummy_request, threadlocals):
    ...
    assert dummy_request._embedded_uuids == set('16157204-8c8f-4672-a1a4-14f4b8021fcd', '775795d3-4410-4114-836b-8eeecf1d0c2f')
    assert dummy_request._linked_uuids == set('16157204-8c8f-4672-a1a4-14f4b8021fcd', '775795d3-4410-4114-836b-8eeecf1d0c2f')
