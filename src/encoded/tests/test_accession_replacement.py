...
def test_replaced_accession_not_in_name(testapp, human_donor):
    donor1 = testapp.post_json('/individual_human', human_donor, status=201).json['@graph'][0]
...
def test_accession_replacement(testapp, human_donor):
    ...
    donor2 = testapp.post_json('/individual_human', human_donor, status=201).json['@graph'][0]
