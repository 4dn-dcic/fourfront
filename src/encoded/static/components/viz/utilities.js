...
var vizUtil = module.exports = {
    ...
    colorForNode : function(node, palette = null, predefinedColors = null){
    ...
    colorForNodeAutoGenerated : function(node, predefinedColors = vizUtil.predefinedColors, cachedOnly = false){
            ...
            if (node.parent) {
                ...
                if (nodeDatum.field === 'accession'){
                    ...
                    color = d3.interpolateRgb(
                        vizUtil.colorForNodeAutoGenerated(node.parent, predefinedColors),
