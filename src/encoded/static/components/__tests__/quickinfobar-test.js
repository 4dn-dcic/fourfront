...
describe('Testing viz/QuickInfoBar.js', function() {
    var page, context, Wrapper, QuickInfoBar, href, contextFilters, barplot_data_unfiltered, barplot_data_filtered;
    ...
    it('There are visible filters in the hover-over dropdown', function() {
        ...
        var filterTerms = _.reduce(
            _.values(searchFilters.contextFiltersToExpSetFilters(contextFilters)),
            function(m,v){ return m.concat(Array.from(v.values())); },
            []
        );
