                    ...
                    <div className="container" id="content">
                        ...
                        <div className="row mt-8">
                            ...
                            <div className="col-12 col-lg-4 social-connections-column">
                                ...
                                <div className="mt-1 mb-1 h-100 d-flex flex-column">
                                    <div className="p-0 flex-grow-1">
                                        <a href="https://doi.org/10.1038/s41467-022-29697-4" target="_blank" rel="noreferrer" className="h-100 text-decoration-none">
                                            ...
                                            <div className="mt-2 social-connections-block-title">4DN Data Portal Paper</div>
                                            <div className="mt-2 social-connections-desc">Learn more about the 4DN data portal on Nature Communications&apos;s website</div>
                                        </a>
                                    </div>
                                    <div className="mt-2">
                                        <a href="https://doi.org/10.1038/s41467-022-29697-4" target="_blank" rel="noreferrer" className="btn btn-primary w-100 mt-1 btn-nature-4dn-article">
                                    ...
                                    <div>
                                        <a href="https://twitter.com/4dn_dcic" target="_blank" rel="noreferrer" className="btn btn-primary w-100 mt-1 btn-follow-on-social-media">
