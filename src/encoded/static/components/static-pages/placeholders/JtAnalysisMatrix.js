...
export class JtAnalysisMatrix extends React.PureComponent {
    ...
    static defaultProps = {
        ...
        "self_planned_results_url"  : null, //? ne yapacağız
    ...
    constructor(props){
        ...
        if (sectionKeys && Array.isArray(sectionKeys) && sectionKeys.length > 0) {
            this.state = _.extend(this.state, _.object(_.map(sectionKeys, (key) => [key + '_results', null])));
        } else {
    ...
    loadSearchQueryResults(){
        ...
        //NEW
        const commonCallbackFn = (sectionKey, result) => {
        ...
        const commonFallbackFn = (sectionKey, result) => {
            const resultKey = sectionKey + "_results";
            const updatedState = {};
        ...
        this.setState(
            ...
            () => {
                _.each(sectionKeys, (sectionKey) => {
                    ...
                    ajax.load(req_url, (r) => commonCallbackFn(sectionKey, r), 'GET', (r) => commonFallbackFn(sectionKey, r), null, {}, excludedHeaders);
                });
            }
        );
    }
    ...
    render() {
        const {
            ...
            groupingProperties4DN, groupingPropertiesEncode, fieldChangeMap, groupingPropertiesSearchParamMap,
            valueChangeMap, columnGrouping4DN, columnGroupingEncode,
        ...
        //NEW
        const isLoading2 = _.any(
            // eslint-disable-next-line react/destructuring-assignment
            _.map(sectionKeys, (key) => this.state[key + '_results'] === null && queries[key].url !== null)
        );
        console.log('xxx isLoading/isLoading2', isLoading, isLoading2);
                ...
                <div className="static-section joint-analysis-matrix">
                    <div className="row">
                        <div className={"col-12 col-md-" + (encode_results ? '6' : '12')}>
                            {headerFor4DN}
                            <VisualBody
                                {..._.pick(this.props, 'self_results_url', 'headerColumnsOrder',
...
class VisualBody2 extends React.PureComponent {
