...
export default class ErrorPage extends React.PureComponent {
    ...
    render() {
        ...
        if (status === 'invalid_login'){
            errorMessage = (
                <div>
                    <h3>The account you provided is not valid. <a className="link-underline-hover" href="/">Return</a> to the homepage.</h3>
                    <h5>
            ...
            errorMessage = <h3>{"The page you've requested does not exist."} <a className="link-underline-hover" href="/">Return</a> to the homepage.</h3>;
        } else if (status === 'forbidden'){
            return <HTTPForbiddenView/>;
        }else{
            errorMessage = <h3>{"The page you've requested does not exist or you have found an error."} <a className="link-underline-hover" href="/">Return</a> to the homepage.</h3>;
        }
    ...
    return (
        <div className="error-page text-start container" id="content">
            ...
            <div className="content fourDN-content">
                <p>
                    If you have an account, please try logging in or return to the <a className="link-underline-hover" href="/">homepage</a>. <br /> For instructions on how to set up an account, please visit the help page for <a className="link-underline-hover" href="/help/account-creation">Creating an Account</a>.
                </p>
            </div>
        </div>
    );
