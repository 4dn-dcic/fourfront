...
export default class ErrorPage extends React.PureComponent {
    ...
    render() {
        ...
        if (status === 'invalid_login'){
            errorMessage = (
                <div>
                    <h3>The account you provided is not valid. <a className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover" href="/">Return</a> to the homepage.</h3>
                    <h5>
            ...
            errorMessage = <h3>{"The page you've requested does not exist."} <a className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover" href="/">Return</a> to the homepage.</h3>;
        } else if (status === 'forbidden'){
            return <HTTPForbiddenView/>;
        }else{
            errorMessage = <h3>{"The page you've requested does not exist or you have found an error."} <a className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover" href="/">Return</a> to the homepage.</h3>;
        }
