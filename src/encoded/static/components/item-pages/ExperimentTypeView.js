...
class OverViewBody extends React.Component {
    ...
    render(){
        ...
        var commonProps = { 'result' : result, 'tips' : tips, 'wrapInColumn' : 'col-sm-6 col-md-3' };
            ...
            <div className="row">
                <div className="col-md-12 col-xs-12">
                    <div className="row overview-blocks">
                        ...
                        <OverViewBodyItem {...commonProps} property='experiment_category' fallbackTitle="Experiment Category" wrapInColumn />
                        <OverViewBodyItem {...commonProps} property='assay_classification' fallbackTitle="Assay Classification" wrapInColumn />
                        <OverViewBodyItem {...commonProps} property='assay_subclassification' fallbackTitle="Experimental Purpose" wrapInColumn />
                        <OverViewBodyItem {...commonProps} property='raw_file_types' fallbackTitle="Raw Files Available" wrapInColumn />
