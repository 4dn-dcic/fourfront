...
export default class FileView extends WorkflowRunTracingView {
    ...
    getTabViewContents(){
        ...
        tabs.push(FileViewVitessce.getTabObject(this.props, width));
                ...
                "files": [
                    {
                        ...
                        "type": "cells",
                        "url": "https://assets.hubmapconsortium.org/ea4cfecb8495b36694d9a951510dc3c6/hubmap_ui/anndata-zarr/secondary_analysis.zarr"
                    },
                    {
