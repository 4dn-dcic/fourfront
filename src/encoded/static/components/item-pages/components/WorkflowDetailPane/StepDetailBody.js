...
export const WorkflowStepTitleBox = React.memo(function WorkflowStepTitleBox(props){
    ...
    return (
        <div className={"box col col-sm-" + (shouldBeFullRow ? '12' : '6')}>
            ...
            { stepHref ?
                <h3 className="text-400"><a href={stepHref} className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover">{ titleString }</a></h3>
                :
