                ...
                <form method="POST" name="user-registration-form was-validated" ref={this.formRef} onSubmit={this.onFormSubmit}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-lg-7">
                            <p>
                                By signing up, you are agreeing to our <a className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover" href="/privacy-policy" target="_blank" rel="noreferrer noopener">Privacy Policy</a>.
                                <br/>
    ...
    render(){
        ...
        const currLabTitle = (
            ...
            currentLabDetails && currentLabDetails['@id'] && currentLabDetails.display_title && (
                <div style={LookupLabField.fieldTitleColStyle}>
                    <a className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover" href={object.itemUtil.atId(currentLabDetails)}
