...
(function(ptree, $, undefined) {
	...
	ptree.build = function(options) {
		...
		*/
		pbuttons.bindButtons(opts);

        if (pedcache.nstore(opts) === 0)
        	pedcache.add(opts);
		...
		ptree.roots[opts.targetDiv.id || 'global'] = root;
...
/*		var warn = node.filter(function (d) {
	...
	ptree.check_ptr_link_clashes = function(opts, anode) {
		var root = ptree.roots[opts.targetDiv.id || 'global'];
