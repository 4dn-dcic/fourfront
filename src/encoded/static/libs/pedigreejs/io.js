...
(function(io, $, undefined) {
    ...
    io.get_printable_svg = function(opts) {
        ...
        let printableContent = opts.targetDiv;
        if (opts.width < tree_dimensions.width || opts.height < tree_dimensions.height ||
            ...
            printableContent.appendChild(printableContent.innerHTML);
            printableContent.childNodes[0].setAttribute('height', wid);
            printableContent.childNodes[0].setAttribute('height', hgt);
            const ytransform = (-opts.symbol_size*1.5*scale);
            printableContent.childNodes[0].childNodes[1].setAttribute('transform', "translate(0, "+ytransform+") scale("+scale+")");
        }
